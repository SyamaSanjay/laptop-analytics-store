...
![Static Laptop Market Overview Dashboard](static_dashboard.png)
![Dynamic Excel Dashboard](dynamic_dashboard.png)
...
- `SQL_Queries_Report.docx` — SQL schema, normalization, and analytical queries
